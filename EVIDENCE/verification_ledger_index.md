...
- VL-132..VL-146 - **INDEX GAP, recorded at VL-147 (2026-07-16), backfill pending.** These fifteen entries exist and are complete in the active ledger, which remains the authoritative record; they were never summarised here. The gap begins at the SAME boundary where STATE.md's "Current verified state" stops accumulating (also VL-131, 2026-07-03): the close protocol's additive-readability bookkeeping (GR-4 clause 3) stopped being executed after that date while the ledger itself kept being appended correctly. Recorded as a named-open item, not silently closed - summarising fifteen entries is author-judgment work, not a mechanical fill.
